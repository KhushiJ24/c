...
//     "today-date"
//   ).innerHTML = `<h2>Today ${date.getDate()}, ${day}<h2/>`;
// }
...
//         document.getElementById("task-manager-section").style.background =
//           "var(--color-3-hex)";
//         show();
//       } else {
...
//           currentLoginUser = username;
//           console.log(password);
//           document.getElementById("task-manager-section").style.display =
//             "flex";
//           authSection.style.display = "none";
//           document.querySelector(".bg-img").src = "";
//           document.getElementById("task-manager-section").style.background =
...
//   document.getElementById("signup-login-switch").innerHTML = switchStateUser
//     ? "Signup"
//     : "Login";
...
//       date.appendChild(document.createTextNode(`${due.getDate()} ${currentMonth} ${due.getFullYear()}`))
